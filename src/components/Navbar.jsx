...
import { Zap, Github, ArrowUpRight, Menu, X } from 'lucide-react';
...
export default function Navbar({ onOpenDownload }) {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-md shadow-lg shadow-orange-950/10 py-3.5 border-b border-orange-100 text-gray-900' : 'bg-transparent py-5 text-white'}`}>
        ...
        <div className="md:hidden bg-white text-gray-900 border-b border-orange-100 px-6 py-6 space-y-4 shadow-xl">
          ...
          <div className="pt-4 border-t border-gray-100 flex flex-col gap-2">
            <button
              ...
              className="w-full py-3 rounded-xl bg-[#FF6A00] text-white font-black text-xs uppercase tracking-wider"
            >
              Pasang App (.IPA / OTA)
            </button>
          </div>
